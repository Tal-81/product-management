...
![Mockup of Product Management on multi device](assets/images/I-am-responsive.png)
...
* ![ChatGPT](https://img.shields.io/badge/-ChatGPT-40A9FF?style=flat-square&logo=openai&logoColor=white)
* ![Gemini](https://img.shields.io/badge/-Gemini-000000?style=flat-square&logo=google-gemini&logoColor=white)
...
### Desktop:
![Screenshot of Product Management on desktop](assets/images/screenshot-desktop.png)

### Mobile:
![Screenshot of Product Management on mobile](assets/images/screenshot-mobile.png)
  
## Design Wireframe
### Desktop Design:
![mokup for Product Management desktop](assets/images/mockup-desktop.jpg)
<br>

### Mobile Design:
![mokup for Product Management mobile](assets/images/mockup-mobile.jpg)
<br>
...
### Test HTML file:
![Test with html validator, the result is no error](assets/images/html-validator.png)

### Test CSS file:
1.  _style.css_:
![Test with CSS validator, the result is no error](assets/images/jigsaw-validator.png)

### Test Javascript file:
![Test with Javascript validator, the result is no error](assets/images/js-validated.png)

### Test Website by Lighthouse Tool from Google Chrome:
*  _Performance, SEO, Accessibility and Prctice_:<br>
![Test with Javascript validator, the result is no error](assets/images/lighthouse-test.png)
...
![aria describedby attribute issue must point to an element in the same document](assets/images/aria-describedby-issue-1.png)
        * add id in other html element and this id must has name like aria-describedby.
![fixed by add id to an html element and that id pointed by describedby attribute](assets/images/aria-describedby-fix-1.png)
...
![buttons group are not active on global scope because they are not created before DOM](assets/images/elements-created-after-Dom-issue.png)
        * Move definition of btnPage from global scope to inside function pagination that needs that variable.
![fixed that by moving definition of buttons from global scope to function scope](assets/images/elements-created-after-Dom-fixed.png)
...
![Line 419 missing Semicolen missing](assets/images/issue-semicolen-missing-on-line-419.png)
...
![Pagination system is runing not I expected](assets/images/pagination-1.png)
...
![follow error by inspector in developer tools in google chrome](assets/images/pagination-2.png)
![follow error by inspector in developer tools in google chrome](assets/images/pagination-3.png)
![all the code is correct just changed mathematical equation that appropriate this process](assets/images/pagination-4.png)
